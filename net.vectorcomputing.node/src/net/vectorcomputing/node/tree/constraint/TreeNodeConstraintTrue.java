...
/**
 * A tree node constraint that always returns <code>true</code>.
 * 
 * @param <T>
 *            the type of tree node the constraint checks
 */
public class TreeNodeConstraintTrue<T extends TreeNode<T>> implements
	 ...
	 * <code>true</code>.
	 */
	public TreeNodeConstraintTrue() {
	}

	/**
	 * @return <code>true</code> regardless of the tree node argument
	 */
	@Override
