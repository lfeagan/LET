...
public abstract class AbstractListStatusPublisher extends List implements IStatusPublisher, IStatusProvider {

	protected final IStatusListenerGroup listeners = new StatusListenerGroup();

	public AbstractListStatusPublisher(Composite parent, int style) {
		super(parent, style);
	}
	...
	@Override
	public java.util.List<IStatusListener> getStatusListeners() {
