...
public abstract class AbstractTextStatusPublisher extends Text implements IStatusPublisher, IStatusProvider {
	
	protected final IStatusListenerGroup listeners = new StatusListenerGroup();

	public AbstractTextStatusPublisher(Composite parent, int style) {
		super(parent, style);
	}
