...
public class InkCartridgeSpecificationsComposite extends Composite {
	 ...
	 * @param style
	 */
	public InkCartridgeSpecificationsComposite(Composite parent, int style) {
		super(parent, style);
		setLayout(new FillLayout(SWT.HORIZONTAL));
		
		treeViewer = new TreeViewer(this, SWT.BORDER | SWT.FULL_SELECTION | style);
		tree = treeViewer.getTree();
		columnHeaders.configureTreeColumns(treeViewer);
		treeViewer.setContentProvider(new InkCartridgeSpecificationsContentProvider());
		treeViewer.setLabelProvider(new InkCartridgeSpecificationCellLabelProvider());
