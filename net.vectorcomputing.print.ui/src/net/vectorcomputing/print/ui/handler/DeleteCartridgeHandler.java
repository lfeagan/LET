...
public class DeleteCartridgeHandler extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		try {
			...
			DialogUtil.openError("Execution Error", "Unable to delete ink cartridge", new Status(IStatus.ERROR, PrintPlugin.PLUGIN_ID, null, e)); 
		}
