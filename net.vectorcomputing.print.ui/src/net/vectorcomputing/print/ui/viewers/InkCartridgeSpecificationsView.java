...
public class InkCartridgeSpecificationsView extends ViewPart {
	...
	private InkCartridgeSpecificationsComposite inkCartridgeSpecificationsTree = null;
	...
	public void createPartControl(Composite parent) {
		...
		inkCartridgeSpecificationsTree = new InkCartridgeSpecificationsComposite(container, SWT.NONE);
		this.getSite().setSelectionProvider(inkCartridgeSpecificationsTree.getSelectionProvider());
	...
	private void createContextMenu() {
		...
		Tree tree = inkCartridgeSpecificationsTree.getTree();
		Menu menu = menuManager.createContextMenu(tree);
		tree.setMenu(menu);
		getSite().registerContextMenu(ID, menuManager, inkCartridgeSpecificationsTree.getTreeViewer());
	}
	...
	public void refresh() {
		if (inkCartridgeSpecificationsTree != null && !inkCartridgeSpecificationsTree.isDisposed()) {
			inkCartridgeSpecificationsTree.refresh();
		}
	}
