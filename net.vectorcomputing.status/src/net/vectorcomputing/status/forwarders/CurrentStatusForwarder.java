...
public class CurrentStatusForwarder extends AbstractStatusForwarder {
	
	private final IStatusProvider statusProvider;
	
	public CurrentStatusForwarder(IStatusProvider statusProvider) {
		this.statusProvider = statusProvider;
	}
	
	@Override
	public void statusChanged(IStatusChangeEvent<?> event) {
		event = new StatusChangeEvent(statusProvider.getStatus());
		super.publishStatusChangeEvent(event);
	}
