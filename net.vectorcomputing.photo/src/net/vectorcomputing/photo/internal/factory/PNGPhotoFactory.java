...
import net.vectorcomputing.photo.formats.PNGPhoto;
import net.vectorcomputing.photo.library.IPhoto;

import org.eclipse.core.filesystem.IFileStore;

public class PNGPhotoFactory implements IPhotoFactory {

	private static final IStringConstraint CONSTRAINT;
	
	static {
		CONSTRAINT = new StringConstrainEndsWithIgnoreCase(".png"); //$NON-NLS-1$
	}
	...
	public IPhoto createPhoto(IFileStore fileStore, IPhotoCatalog catalog) {
		return new PNGPhoto(fileStore, catalog);
	}
	...
	public boolean equals(Object obj) {
		if (obj != null) {
			return obj.getClass().equals(PNGPhotoFactory.class);
		} else {
			return false;
		}
	}
