...
public abstract class AbstractCompositeStatusPublisher extends Composite implements IStatusPublisher, IStatusProvider {

	protected final IStatusListenerGroup listeners = new StatusListenerGroup();
	
	public AbstractCompositeStatusPublisher(Composite parent, int style) {
		super(parent, style);
	}
