...
public abstract class AbstractButtonStatusPublisher extends Button implements IStatusPublisher, IStatusProvider {

	protected final IStatusListenerGroup listeners = new StatusListenerGroup();

	public AbstractButtonStatusPublisher(Composite parent, int style) {
		super(parent, style);
	}
